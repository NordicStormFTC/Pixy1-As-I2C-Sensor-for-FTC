...
make sure that you configure your camera to use the I2C interface on pixymon, or else none of this will work. Also make sure that if you are using a pixy2 camera, you enable pixy1 capatability using pixymon.
